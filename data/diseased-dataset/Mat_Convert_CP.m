%%CP-XX-Vectors file to ECG, SCG, and GCG matrix convertion 
%%and annotation demo
% The purpose is to form standardized matrix that corresponds to the
% annotation files and correct reverted axis due to attachment differences
...
CP_Number=6;%%Change this number to refer to different subjects

VectorMatFileName="CP-"+num2str(CP_Number,'%02d')+"-Vectors.mat";
ECGFileName="CP-"+num2str(CP_Number,'%02d')+"-ECG.mat";
SCGFileName="CP-"+num2str(CP_Number,'%02d')+"-SCG.mat";
GCGFileName="CP-"+num2str(CP_Number,'%02d')+"-GCG.mat";
load(VectorMatFileName);
fs=256;%sampling rate
if CP_Number<39
ECG_Matrix=[Shimmer_D0CD_ECG_LARA_24BIT_CAL1, Shimmer_D0CD_ECG_LLLA_24BIT_CAL1,Shimmer_D0CD_ECG_LLRA_24BIT_CAL1];
SCG_Matrix=[-Shimmer_D0CD_Accel_LN_X_CAL1, -Shimmer_D0CD_Accel_LN_Y_CAL1, Shimmer_D0CD_Accel_LN_Z_CAL1];
GCG_Matrix=[-Shimmer_D0CD_Gyro_X_CAL1, -Shimmer_D0CD_Gyro_Y_CAL1, Shimmer_D0CD_Gyro_Z_CAL1];
else
ECG_Matrix=[Shimmer_D0CD_ECG_LARA_24BIT_CAL1, Shimmer_D0CD_ECG_LLLA_24BIT_CAL1,Shimmer_D0CD_ECG_LLRA_24BIT_CAL1];
SCG_Matrix=[Shimmer_D0CD_Accel_LN_X_CAL1, Shimmer_D0CD_Accel_LN_Y_CAL1, Shimmer_D0CD_Accel_LN_Z_CAL1];
GCG_Matrix=[Shimmer_D0CD_Gyro_X_CAL1, Shimmer_D0CD_Gyro_Y_CAL1, Shimmer_D0CD_Gyro_Z_CAL1];
